...
function addKetcherChemContextToolbar(editor){
	...
	editor.ui.registry.addContextToolbar('chemicalFileViewableKetcher', {
		...
		items: 'attachmentinfopopup attachmentdownload | resizeImage | ketcherViewable | stoichiometry',
		position: 'node',
		scope: 'node'
	});
	editor.ui.registry.addContextToolbar('chemicalElementEditableKetcher', {
		...
		items: 'downloadImage | resizeImage | ketcherEditable | stoichiometry',
		position: 'node',
		scope: 'node'
	});
    ...
    tooltip: 'View stoichiometry',
    icon: 'foo',
    onAction: function () { editor.execCommand("cmdStoichiometry"); },
  });
}
