...
function FormatChoice({
    ...
    const repoCheck = useCallback(() => {
        ...
        axios
            .get<Array<Omit<Repo, "repoCfg"> & { options: object }> | { exceptionMessage: string }>(url)
            .then((response) => {
                    ...
                    <FormControlLabel
                        ...
                        label={
                            <>
                                ...
                                <OptionExplanation>
                                    Exported data is machine readable. Good for archiving, or transferring data from one
                                    RSpace server or user to another.
                                </OptionExplanation>
                            </>
                        }
                    />
                        ...
                        label={
                            <>
                                ...
                                <OptionExplanation>
                                    {pdfAvailable ? (
                                        <>
                                            A read-only version of your RSpace documents will be placed in the
                                            &apos;Exports&apos; area of the Gallery
                                        </>
                                    ) : (
                                        <>
                                            All selected items are attachments &mdash; there are no RSpace documents to
                                            export.
                                        </>
                                    )}
                                </OptionExplanation>
                            ...
                            label={
                                <>
                                    ...
                                    <OptionExplanation>
                                        {wordAvailable ? (
                                            <>
                                                MS Word version of your RSpace documents will be placed in the
                                                &apos;Exports&apos; area of the Gallery.
                                            </>
                                        ) : (
