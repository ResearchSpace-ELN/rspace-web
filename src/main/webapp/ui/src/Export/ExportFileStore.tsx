                ...
                await confirm(
                    ...
                    <>
                        ...
                        {validationData.scanResultsTotalFileSize > validationData.maxArchiveSizeBytes ? (
                            <span>
                                {" "}
                                exceeds the global limit set for size of RSpace archive file. Use file filters to
                                exclude some files, or ask your System Admin to raise the limit on archive size.
                            </span>
                        ) : (
                            <span>
                                {" "}
                                exceeds disk space currently available on RSpace server. Use file filters to exclude
                                some files, or contact your System Admin.
                            </span>
                        )}
                    </>,
                    "OK",
        ...
        <Grid container spacing={1} direction="column">
            ...
            {!loadingQuickPlan && totalFilesFound > 0 && (
                <>
                    ...
                    <Grid item>
                        <LoginStatus fileSystems={fileSystems} fileStoreCheck={doNotAwait(fileStoreCheck)} />
                    </Grid>
