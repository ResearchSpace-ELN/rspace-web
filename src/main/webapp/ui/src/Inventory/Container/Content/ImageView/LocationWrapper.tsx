...
function LocationWrapper({ children, parentRect, location }: LocationWrapperArgs): React.ReactNode {
    ...
    }, [parentRect, location.setDimensions, location.setPosition, positionX, positionY]);

    return (
        <div className={classes.container} style={{ left: location.x, top: location.y }} ref={cellRef}>
