  ...
  forbidden: [
    {
      ...
      severity: "error",
      from: {
        path: "src/eln/AppBar.tsx",
      }, 
      to: {
        reachable: true,
        pathNot: "src/components/AppBar.tsx",
...
//      from: {
//        path: '^(src)',
//        pathNot: '__tests__|\.(spec|test)\.(js|mjs|cjs|ts|ls|coffee|litcoffee|coffee\.md)$'
//      },
//      to: {
//        dependencyTypes: [
//          'npm-dev'
...
//    {
//      name: "Inventory-only",
//      comment: "Modules containing generic code or ELN code should not depend on Inventory components or Inventory-specific code.",
//      from: {
//        // only this whitelist of paths...
//        pathNot: "src/Inventory|src/Router.js|src/eln-inventory-integration|src/stores|src/App.js|src/components/PublicPages/IdentifierPublicPage.js",
//      },
//      to: {
...
//    {
//      name: "Apps-only",
//      comment: "Modules containing generic code, Inventory code, or other parts of the ELN should not depend on code specific to the apps page.",
//      from: {
...
//    {
//      name: "Sysadmin-only",
//      comment: "Modules containing generic code, Inventory code, or other parts of the ELN should not depend on code specific to the sysadmin page.",
//      from: {
...
//      comment: "src/stores/definitions should only depend on themselves or utils",
//      from: {
...
//      comment: "src/util should not depend on other parts of the codebase; they should be pure functions and simple data structures.",
//      from: {
//        path: "src/util",
//      },
//      to: {
