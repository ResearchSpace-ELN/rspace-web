...
public class SignupController extends BaseController {
  ...
  private String getEmailFromRemote(HttpServletRequest req) {
    String emailString = remoteUserPolicy.getOtherRemoteAttributes(req).get(RemoteUserAttribute.EMAIL);
  ...
  private boolean getIsAllowedPiRoleFromRemote(HttpServletRequest req) {
    String rc = remoteUserPolicy.getOtherRemoteAttributes(req).get(RemoteUserAttribute.IS_ALLOWED_PI_ROLE);
