...
public class UpdateFilestoreLinkTypesInFieldContentIT extends AbstractDBHelpers {
  ...
  @Test
  public void checkFilestoreLinkTypesUpdate()
      throws IOException, SetupException, CustomChangeException {

    updater = new UpdateFilestoreLinkTypesInFieldContent();
    updater.setUp();
  ...
  private void addOldFilestoreLink(Record record) throws IOException {
    String oldFilestoreLink =
        "<a class=\"nfs_file mceNonEditable\" href=\"#\" rel=\"test\">test</a>";
